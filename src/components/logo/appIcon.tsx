    ...
    <>
      <LogoLink>
        ...
        >
          ...
          >
            <path
              d="M312 1789 c-50 -25 -99 -80 -113 -129 -6 -23 -9 -261 -7 -681 l3
...
-35 -109 18 -109 123 0 114 52 167 118 120z"
            ...
            <path
              d="M1097 1663 c-4 -3 -7 -39 -7 -80 l0 -73 50 0 50 0 0 80 0 80 -43 0
c-24 0 -47 -3 -50 -7z"
            />
            <path
              d="M1130 1480 c0 -5 5 -10 10 -10 6 0 10 5 10 10 0 6 -4 10 -10 10 -5 0
-10 -4 -10 -10z"
            />
            <path
              d="M950 1260 c0 -5 23 -10 50 -10 28 0 50 5 50 10 0 6 -22 10 -50 10
-27 0 -50 -4 -50 -10z"
            />
            <path
              d="M1366 1004 c-13 -35 -7 -54 19 -54 18 0 25 5 25 19 0 29 -11 51 -25
51 -7 0 -16 -7 -19 -16z"
            />
          </g>
        </svg>
